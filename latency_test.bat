rm "./pub.csv"
rm "./sub1.csv"
start cmd /k perftest_java.bat -pub -dataLen 4096 -numSubscribers 1 -domain 1 -executionTime 10 -latencyTest -latencyCount 1
start cmd /k perftest_java.bat -sub -dataLen 4096 -domain 1 -fileName sub1.csv
sleep 20
...
rm "./pub.csv"
rm "./sub1.csv"
start cmd /k perftest_java.bat -pub -dataLen 4096 -numSubscribers 1 -domain 1 -executionTime 120 -latencyTest -latencyCount 1
start cmd /k perftest_java.bat -sub -dataLen 4096 -domain 1 -fileName sub1.csv
sleep 130
...
rm "./pub.csv"
rm "./sub1.csv"
start cmd /k perftest_java.bat -pub -dataLen 4096 -numSubscribers 1 -domain 1 -executionTime 300 -latencyTest -latencyCount 1
start cmd /k perftest_java.bat -sub -dataLen 4096 -domain 1 -fileName sub1.csv
sleep 310
